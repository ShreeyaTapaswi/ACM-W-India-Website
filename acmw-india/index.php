  ...
  <div class="row" style="background-color: white; padding-top: 10px;">
    <div class="columns small-12">
      <ul class="breadcrumbs">
        <ul id="crumbs" class="breadcrumbs"><li><a href="#">Home</a></li><li>Newsletter</li></ul>      </ul>
    </div>
  </div>
    ...
    <article class="has-edit-button" id="SkipTarget" tabindex="-1">
      <div class="row">
        ...
        <section class="home-section">
          <!-- <div class="section-tag">Mission Statement</div> -->
          <h2 class="section-heading" style="text-align:center;"><strong>Mission Statement</strong></h2>
          <div class="mission-text">
            <p>The ACM-W India mission is to foster women's education and careers in computing, and encourage the Indian professional and scholarly community to promote the participation and professional development of women in computing and recognise their contributions to the field.</p>
            <p>ACM-W India fulfils the <a class="mission-link" href="https://women.acm.org/" target="_blank">ACM-W mission</a> to support, celebrate, and advocate internationally for the full engagement of women in all aspects of the computing field, providing a wide range of programs and services to ACM members and working in the larger community to advance the contributions of technical women.</p>
            <p>ACM-W India is a regional chapter of <a class="mission-link" href="https://women.acm.org/" target="_blank">ACM-W</a> and works to fulfil the ACM-W mission across India's diverse landscape, from metropolitan tech hubs to Tier-2 and Tier-3 cities and beyond.</p>
          </div>
        </section>

        <!-- Latest Updates — 2-col card grid (ACM-W Europe style) -->
        <section class="home-section">
          <div class="section-tag">Latest Updates</div>
          <h2 class="section-heading" style="text-align:center;"><strong>Latest Updates</strong></h2>
          ...
          <div class="simple-grid-container">
            ...
            <div class="clean-post-card">
              ...
              <p>As we look ahead to 2026, we would like to extend our sincere thanks to all members of our community who have contributed to our work over the past year. In particular, we are grateful to the ACM-W India Executive Committee; the organizing committees of our flagship events; our chapter officers; and all our volunteers. The achievements of ACM-W India are possible only through your commitment and hard work.</p>
              
              <p>Whatever the coming year may hold, we look forward to supporting you and to celebrating your professional and personal milestones.</p>
              
              <p>Happy new year!<br><strong>Dr. Geetanjali Kale</strong><br>ACM-W India Chair</p>
              
              <a href="pages/about.php" class="cta-link-simple">Read more about us &raquo;</a>
            </div>
            ...
            <div class="clean-post-card">
              ...
              <h3 style="color: #043b87;">🇮🇳 India at the European Girls’ Olympiad in Informatics (EGOI-2026)</h3>
              <p>Held in Cesenatico, Italy (12–18 May 2026), the Indian team showcased exceptional talent and brought pride to the nation.</p>
              <p><strong>👏 Congratulations to:</strong></p>
              <ul>
                <li>🥇 <strong>Swasti Vitthal Patil</strong> – Gold Medal (India’s first-ever Gold Medal at EGOI)</li>
                <li>🥈 <strong>Mansi Sane</strong> – Silver Medal</li>
                <li>🥉 <strong>Diya Sathishdev</strong> – Bronze Medal</li>
                <li>🎖️ <strong>Lyra Floyd Gonsalves</strong> – Honourable Mention</li>
              </ul>
              
              <p>Sonia Garcha led the Indian contingent from CSpathshala, who is also a committee member at large - ACM-W India, an educator and computing mentor dedicated to promoting computational thinking and nurturing young talent in informatics and computer science education across India.</p>
              
              <hr style="border:none;border-top:1px solid #eaeaea;margin:20px 0;">

              <h3 style="color: #043b87;">🌎 Asia-Pacific Informatics Olympiad (APIO-2026)</h3>
              <p>India also achieved remarkable success at APIO-2026 with:</p>
              <ul>
                <li>🥇 <strong>Samik Goyal</strong> – Gold Medal</li>
                <li>🥉 <strong>Naman Singh</strong>, <strong>Mohammad Farhat</strong>, <strong>Arjun Tyagi</strong>, <strong>Avighna Chhatrapati</strong> – Bronze Medals</li>
              </ul>

              <p>These achievements reflect the growing strength of India’s young computing talent and the importance of creating inclusive opportunities for students in technology and problem-solving.</p>
              
            </div>

            <!-- Card 3: Latest Newsletter -->
            <div class="clean-post-card">
              <h2><a href="pages/newsletter.php" style="color:inherit;">Check out our most recent Newsletter</a></h2>
              <p>The latest edition of the ACM-W India Connections Newsletter includes:</p>
              <ul>
                <li>Message from the ACM-W India Chair</li>
                <li>Empowering Women in Computing: Scholarship Opportunities</li>
                <li>Event Recap: Grad Cohort '25</li>
                <li>Scholar Spotlights — Student Stories</li>
                <li>Upcoming Events and Announcements</li>
                <li>Community Member Highlights</li>
              </ul>
              <a href="pages/newsletter.php" class="cta-link-simple">Read the Newsletter &raquo;</a>
            </div>

            <!-- Card 4: Blog -->
            <div class="clean-post-card">
              <h2><a href="pages/blog.php" style="color:inherit;">Check out our most recent Blog posts</a></h2>
              <h3 style="color: #043b87; margin-top: 0;">Women in Computing — Stories from India</h3>
              <p>ACM-W India invites members to share their journeys, research, and insights through our blog. From navigating academia to building startups, our members' stories inspire the next generation.</p>
              <hr style="border:none;border-top:1px solid #eaeaea;margin:20px 0;">
              <h3 style="color: #043b87;">Telling Our Stories</h3>
              <p>Each year, we spotlight women at conferences, workshops, and events across India. Read about their experiences and share yours.</p>
              <a href="pages/blog.php" class="cta-link-simple">Visit the Blog &raquo;</a>
            </div>
