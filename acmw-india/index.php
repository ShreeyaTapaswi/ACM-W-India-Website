      ...
      <div class="row">
        ...
        <section class="home-section">
          ...
          <div class="updates-grid">
            ...
            <div class="shadowed-cta">
              <div class="card-icon"><i class="fa fa-comment-dots"></i></div>
              <h2>Message from ACM-W India Chair<br><strong>— Prof. Geetanjali Kale</strong></h2>
              <p>Welcome to ACM-W India! As we continue to build a vibrant community of women in computing, I am excited to share the incredible work our chapters and volunteers are doing across India.</p>
              <p>In 2025, we welcomed several new student chapters, hosted three flagship events — Lady Ada, Nariyukti, and Grad Cohort — and expanded our newsletter to reach thousands of members. Every milestone is a testament to the dedication of our community.</p>
              <p>We look forward to 2026 with renewed energy. Whether you are a student discovering computing, a professional shaping the field, or an educator inspiring the next generation, ACM-W India is your community.</p>
              <div class="card-footer">
                <a href="pages/about.php" class="cta-link">Read more about us <i class="fa fa-arrow-right fa-xs"></i></a>
              </div>
            </div>

            <!-- Card 2: Upcoming Event -->
            <div class="shadowed-cta">
              <div class="card-icon"><i class="fa fa-calendar-star"></i></div>
              <h2><strong>Upcoming Events — 2026</strong></h2>
              <p>ACM-W India hosts a series of flagship events celebrating and empowering women in computing:</p>
              <ul>
                <li><strong>Lady Ada 2026</strong> — Annual celebration of women's contributions to computing, named after Ada Lovelace.</li>
                <li><strong>Nariyukti 2026</strong> — A skill-building and networking event for women in tech.</li>
                <li><strong>Grad Cohort 2026</strong> — Mentorship and career guidance event for women graduate students.</li>
              </ul>
              <p>Stay tuned for announcements on dates, venues, and registration for all upcoming events.</p>
              <div class="card-footer">
                <a href="pages/events.php" class="cta-link">View all events <i class="fa fa-arrow-right fa-xs"></i></a>
              </div>
            </div>
            ...
            <div class="shadowed-cta">
              ...
              <h2><strong><a href="pages/newsletter.php">Check out our most recent Newsletter</a></strong></h2>
              <div>
              ...
              <div class="card-footer">
                <a href="pages/newsletter.php" class="cta-link">Read the Newsletter <i class="fa fa-arrow-right fa-xs"></i></a>
              </div>
            </div>

            <!-- Card 4: Blog -->
            <div class="shadowed-cta">
              <div class="card-icon"><i class="fa fa-pen-nib"></i></div>
              <h2><strong><a href="pages/blog.php">Check out our most recent Blog posts</a></strong></h2>
              <div>
                <h3 style="font-size:.95rem;margin-bottom:10px;">Women in Computing — Stories from India</h3>
                ...
                <h3 style="font-size:.95rem;margin-bottom:8px;">Telling Our Stories</h3>
              ...
              <div class="card-footer">
                <a href="pages/blog.php" class="cta-link">Visit the Blog <i class="fa fa-arrow-right fa-xs"></i></a>
              </div>
            </div>
